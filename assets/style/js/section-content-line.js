...
jQuery(document).ready(function(){ 
    ...
    /*code for check 1st word capital, finger based on that*/
    ...
    //  alert("matchleftkey"+matchleftkey);
    //  alert("matchrightkey"+matchrightkey);
    if(matchleftkey!=-1)
    {
        /*f_defaultnew left hand,
          j_defaultnew right hand*/         
        $("#f_defaultnew").hide();
        $("#j_defaultnew").show();  
    }
    if(matchrightkey!=-1)
    ...
    /*code for wpm and accuracy start*/
    ...
    jQuery(document).on("keypress",function(e){
        ...
        if(e.which === 8){
            ...
            if(time!='00:00'){
                ...
                /*code for append typing content*/
    ...
    //   var nextChar=jQuery(".lesson-content").find('div:nth-child(1)').find('span:nth-child(1)').text();
        ...
        if(nextCharCode!="32")  
        {
            ...
            if(matchleftkeypress!=-1)
            {
                // alert("matchleftkeypress"+matchleftkeypress); 
                $(".newhandkey-32").hide();	
                $(".newhandkey-15 ").hide();		
                $("#f_defaultnew").hide();
                $(".newhandkey-left").hide();
            ...
            if(matchrightkeypress!=-1)
            {
                // alert("matchrightkeypress"+matchrightkeypress); 
            ...
            // if(shiftkey!=''){
            //     // alert("yesshift"+shiftkey);
            // if(nextfindHand=='left')
            // {
            //     var shiftHand='rightnew';
            // }
            // else
            // {
            //     var shiftHand='left';
