...
function scoreCard(){
    ...
    if(jQuery("#islogin").val() == 1){
        ...
        jQuery.ajax({
            ...
            data: {'p': 'wpmscoresave', 'testname': testname, 'date': today, 'length': typetime, 'speed': speed, 
            ...
            success: function(response){
                ...
                jQuery("#userprint").attr('href', base_url+'/'+response.certificate_id+'/user-wpm-pdf.html');
